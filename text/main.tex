...
\noindent For the last part of the analysis since we wanted to see if after all, we could get realistic results, we went back to the Big Data Future and applied the \acrshort{if} method with a very high tolerance of 35\% and also balanced for regions and sectors, which caused a significant reduction in the number of rows.
