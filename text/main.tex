...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/code/models/general_regression/splines/3D/Big Data future - IF HARD Balanced/value_value×region_code.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/code/models/general_regression/splines/3D/Big Data future - IF HARD Balanced/value_value_avg_24m×region_code.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/code/models/neural_network/binary_classifier_nn/class_architecture_analysis_quality.png} %TODO: change oic here
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/general_regression/splines/3D/Small Data future - IF/dividend_dividend_avg_24m×region_code.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/general_regression/splines/3D/Small Data future - IF/growth_growth_avg_24m×region_code.png}
        \caption{Small Data Future \acrshort{if} -  Region x Quality}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/general_regression/splines/3D/Small Data future - IF/quality_quality_avg_24m×region_code.png}
        \caption{Small Data Future \acrshort{if} -  Region x Quality}
...
\begin{table}[h!]
    ...
    \hline
    \textbf{Objetivo de Desarrollo Sostenible (ODS)} & \textbf{Grado de relación} \\
    \hline
    ODS 1. Fin de la pobreza & No aplicable \\
    \hline
    ODS 2. Hambre cero & No aplicable \\
    \hline
    ODS 3. Salud y bienestar & No aplicable \\
    \hline
    ODS 4. Educación de calidad & Medio \\
    \hline
    ODS 5. Igualdad de género & No aplicable \\
    \hline
    ODS 6. Agua limpia y saneamiento & No aplicable \\
    \hline
    ODS 7. Energía asequible y no contaminante & No aplicable \\
    \hline
    ODS 8. Trabajo decente y crecimiento económico & Alto \\
    \hline
    ODS 9. Industria, innovación e infraestructura & Alto \\
    \hline
    ODS 10. Reducción de las desigualdades & No aplicable \\
    \hline
    ODS 11. Ciudades y comunidades sostenibles & No aplicable \\
    \hline
    ODS 12. Producción y consumo responsables & Alto \\
    \hline
    ODS 13. Acción por el clima & No aplicable \\
    \hline
    ODS 14. Vida submarina & No aplicable \\
    \hline
    ODS 15. Vida de ecosistemas terrestres & No aplicable \\
    \hline
    ODS 16. Paz, justicia e instituciones sólidas & No aplicable \\
    \hline
    ODS 17. Alianzas para lograr los objetivos & No aplicable \\
    \hline
    \end{tabular}
    \caption{Relación del TFG con los Objetivos de Desarrollo Sostenible (ODS) de la Agenda 2030}
\end{table}
