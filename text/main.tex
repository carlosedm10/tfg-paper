...
\begin{figure}[H]
    ...
    \label{fig:region_performance_second_model}
\end{figure}

\noindent In this case, the residues improve significantly to the point that we are only almost left with the autocorrelations issue for most of the regions and models. And here we can be certain that the big issue we were having with the outliers is comming mostly from \textit{Asia \& Oceania}; which is also the region with more datapoints overall.

\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/USA/quality_profit_1m_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/USA/quality_profit_1y_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/USA/quality_profit_5y_residuals.png}
    \end{subfigure}
    \caption{USA \textit{Yeo-Johnson} - Model Residuals}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/EU/quality_profit_1m_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/EU/quality_profit_1y_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/EU/quality_profit_5y_residuals.png}
    \end{subfigure}
    \caption{EU \textit{Yeo-Johnson} - Model Residuals}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/AS/quality_profit_1m_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/AS/quality_profit_1y_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/AS/quality_profit_5y_residuals.png}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/LAT/quality_profit_1m_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/LAT/quality_profit_1y_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/LAT/quality_profit_5y_residuals.png}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/AF/quality_profit_1m_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/AF/quality_profit_1y_residuals.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/code/models/linear_regression/second_model/AF/quality_profit_5y_residuals.png}
    \end{subfigure}
...
\noindent With these more stable residues; we can study in more detail the coefficients' behavior. Notting that they stay constant with the results before applying the transformation; which is a good sign of consistency. These results also show patterns that could be supported by economical theory as we are about to explore.
...
\noindent \textbf{Asia \& Oceania} in table~\ref{tab:asia_gaussian_model_consistency}, shows that for this region \textbf{all factors are positive and significant}. This result could mean that in this growing market, the market makes more rational decisions and since brands are not as strong as in the US or Europe. But at the same time it comes with a less stable market with a lot of volatility and outliers, so we should be careful.
...
\begin{table}[H]
    ...
    \begin{tabular}{lccccccc}
        ...
        \multirow{3}{*}{\textbf{Dividend}} 
            ...
            & Sign & + & – & + & + & + & + \\
            & t-value & 2.993752 & -4.461563 & 8.253964 & 2.915853 & 5.427420 & 4.236314 \\
        \midrule
        \multirow{3}{*}{\textbf{Growth}} 
        ...
        \multirow{3}{*}{\textbf{Value}} 
            ...
            & Sign & + & 0 & + & 0 & + & + \\
            & t-value & 9.745774 & -- & 11.726903 & -- & 10.919653 & 6.196305 \\
        \bottomrule
    \end{tabular}
    \label{tab:latam_gaussian_model_consistency}
\end{table}

\noindent Finally, the region \textbf{Africa \& Middle East} --in table~\ref{tab:africa_gaussian_model_consistency}-- is very unpredictable with this model, where we can only highlight that \textbf{Quality is positive and significant for all time horizons} and Dividend seems to have a small negative impact; but since the effects are so small it could be overfitting.
