...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Small Data Future \acrshort{if} (35\%) - \gls{shap} Consistency}
    ...
    \end{subfigure}
    \caption{\gls{shap} Consistency for Small and Big Data Future \acrshort{if} (35\%)}
\end{figure}
...
\noindent For regresors, we have implemented a simple \acrshort{nn} with one hidden layer of 64 neurons. And we have done this for both, the small and big data future \acrshort{if} (35\%).
...
\noindent During the anaylis we have identified a series of common patterns with enough consistency, significance, and coherence to be taken into account.
